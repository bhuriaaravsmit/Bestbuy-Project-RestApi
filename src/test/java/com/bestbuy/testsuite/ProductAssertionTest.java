...
public class ProductAssertionTest {
    ...
    //  Verify that if the total is equal to 51957
    @Test
    public void total() {
    ...
    @Test
    public void secondNameOfProductId() {
